        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-1">
            <div className="bg-gray-800/50 p-8 rounded-xl">
              <img src={builder.image} alt={builder.name} className="w-48 h-48 rounded-full mx-auto mb-6 object-cover" />
              <h1 className="text-3xl font-bold text-center mb-2">{builder.name}</h1>
              <p className="text-yellow-400 text-center mb-6">{builder.role}</p>

              <div className="flex justify-center gap-4 mb-8">
                {builder.social.github && (
                  <a href={builder.social.github} className="text-gray-400 hover:text-white transition-colors">
                    <Github size={24} />
                  </a>
                )}
                {builder.social.linkedin && (
                  <a href={builder.social.linkedin} className="text-gray-400 hover:text-white transition-colors">
                    <Linkedin size={24} />
                  </a>
                )}
                {builder.social.twitter && (
                  <a href={builder.social.twitter} className="text-gray-400 hover:text-white transition-colors">
                    <Twitter size={24} />
                  </a>
                )}
              </div>
