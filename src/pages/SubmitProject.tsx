        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-gray-800/50 p-8 rounded-xl">
              <h2 className="text-2xl font-semibold mb-6">Why Choose Build DAO?</h2>
              <div className="space-y-6">
                <div className="flex gap-4">
                  <Clock className="text-yellow-400 flex-shrink-0" size={24} />
                  <div>
                    <h3 className="font-semibold mb-2">Fast Turnaround</h3>
                    <p className="text-gray-300">Most MVPs are delivered within 2-4 weeks</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Built by experienced developers with proven track records</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Production-ready code with deployment support</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/50 p-8 rounded-xl">
              <h2 className="text-2xl font-semibold mb-4">Recent Success Stories</h2>
              <div className="space-y-4">
                <blockquote className="border-l-2 border-yellow-400 pl-4">
                  <p className="text-gray-300 italic mb-2">"Build DAO delivered our DeFi platform in just 3 weeks. Exceptional quality and communication."</p>
                  <footer className="text-sm text-gray-400">- Alex K., DeFi Startup Founder</footer>
                </blockquote>
                <blockquote className="border-l-2 border-yellow-400 pl-4">
                  <p className="text-gray-300 italic mb-2">"The team's expertise in web3 helped us launch faster than expected. Highly recommended!"</p>
                  <footer className="text-sm text-gray-400">- Sarah M., NFT Marketplace Creator</footer>
                </blockquote>
              </div>
            </div>
          </div>
